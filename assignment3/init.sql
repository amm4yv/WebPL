...
USE Allison;
CREATE TABLE Sender (Sender_id int primary key not null, Sender_name text not null, Sender_email text not null, Password text not null, Reset text);
CREATE TABLE Admin (Admin_id int primary key not null, Name text not null, Email text not null, Password text not null, Reset text);
